...
EEMEM   char version[] = "I2C Motor, Servo & Quadrature Encoder 0V2.6";
...
extern uint16_t rtquada;
extern uint16_t rtquadb;
...
//initialise Servo 1 & Servo 2 16 bit timer 0 Approx 1 micro second resolution
    ...
    USI_Slave_register_buffer[0x00]=&OCR0A;
    USI_Slave_register_buffer[0x01]=&OCR0B;
    USI_Slave_register_buffer[0x02]=&Motor1;
    USI_Slave_register_buffer[0x03]=&Motor2;
    USI_Slave_register_buffer[0x04]=&OCR1AH;
    USI_Slave_register_buffer[0x05]=&OCR1AL;
    USI_Slave_register_buffer[0x06]=&OCR1BH;
    USI_Slave_register_buffer[0x07]=&OCR1BL;
    USI_Slave_register_buffer[0x08]=&quadal;
    USI_Slave_register_buffer[0x09]=&quadah;
    USI_Slave_register_buffer[0x0a]=&quadbl;
    USI_Slave_register_buffer[0x0b]=&quadbh;
    USI_Slave_register_buffer[0x0c]=NULL;
    USI_Slave_register_buffer[0x0d]=NULL;
    USI_Slave_register_buffer[0x0e]=NULL;
